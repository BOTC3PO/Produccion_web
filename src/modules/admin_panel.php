<div class="h-screen w-full bg-white relative flex overflow-hidden">
    ...
    <!-- Sidebar -->
    <div class="h-full w-5p flex flex-col space-y-10 items-center justify-center relative bg-gray-800 text-white">
        <!-- Profile -->
        <div
    ...
    <div
        class="h-full w-95p flex flex-wrap items-start justify-start rounded-tl grid-flow-col auto-cols-max gap-4 #overflow-y-scroll">
